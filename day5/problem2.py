...
class Range:
    def __init__(
        self, input_string: str | None = None, lower_number: int | None = None, higher_number: int | None = None
    ):
        if input_string:
        ...
        for idx, range_to_check in enumerate(ranges):
            for idx_other_ranges, range_to_check_against in enumerate(ranges):
                ...
                if check_if_ranges_overlap(range_to_check, range_to_check_against):
                    ...
                    ranges.pop(idx)
                    new_range = Range(
                        lower_number=min([range_to_check.lower_number, range_to_check_against.lower_number]),
